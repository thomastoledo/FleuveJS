...
describe("PromiseObservable", () => {
  describe("creation", () => {
    ...
    it("should create a new PromiseObservable with a rejected value", (done) => {
      const obs$ = new PromiseObservable<number>(
  ...
  describe("pipe", () => {
    it("should create a new PromiseObservable with a resolved value", async () => {
      const obs$ = new PromiseObservable<number>(Promise.resolve(0)).pipe(
        map((value) => value + 12)
      );
      obs$.subscribe({
  ...
  describe("subscribe", () => {
    ...
    it("should execute the subscriber error callback", (done) => {
